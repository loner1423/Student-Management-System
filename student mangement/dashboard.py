...
class RMS:
    def __init__(self,root):
        ...
        #====icons===
        self.logo_dash=ImageTk.PhotoImage(file="pic1.jpg")
        #====title===
        ...
        self.lbl_student=Label(self.root,text="Total Students\n[ 0 ]",font=("goudy old style",20),bd=10,relief=RIDGE,bg="#062fe4",fg="white")
        self.lbl_student.place(x=710,y=530,width=300,height=100)
        
        self.lbl_result=Label(self.root,text="Total Results\n[ 0 ]",font=("goudy old style",20),bd=10,relief=RIDGE,bg="#2be406",fg="white")
        self.lbl_result.place(x=1020,y=530,width=300,height=100)
        
        #=====footer=====
        footer=Label(self.root,text="SRMS-Student Result Mangement System\nContact US for any Techinal Issue: 987xxxxx21",font=("goudy old style",12),bg="#262626",fg="white").pack(side=BOTTOM,fill=X)
