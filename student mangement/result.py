...
class resultClass:
    def __init__(self,root):
        ...
        #=========button===============
        btn_add=Button(self.root,text="Submit",font=("times mew roman",15),bg="lightgreen",activebackground="lightgreen",cursor="hand2",command=self.add).place(x=300,y=420,width=120,height=35)
        btn_clear=Button(self.root,text="Clear",font=("times mew roman",15),bg="lightgray",activebackground="lightgray",cursor="hand2",command=self.clear).place(x=430,y=420,width=120,height=35)
        
        #=======image===========
        self.bg_img=Image.open("pic1.jpg")
    ...
    def add(self):
        ...
        try:
            if self.var_name.get()=="":
                messagebox.showerror("Error","Please first search stduent record",parent=self.root)
            else:
